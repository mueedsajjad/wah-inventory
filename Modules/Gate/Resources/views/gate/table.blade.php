                    ...
                    <div class="row">
                        ...
                        <table>
                            ...
                            @foreach($details as $data)
                                <tr>
                                    <div class="mome">
                                        <td><input type="text" class="form-control"  name="po_id" value="{{$data->material_requisition_id}}" readonly></td>
                                        <td><input type="text" class="form-control"  name="material_name[]" value="{{$data->material_name}}" readonly></td>
                                        <td><input type="text" class="form-control"  name="uom[]" value="{{(\Illuminate\Support\Facades\DB::table('unit')->find($data->UOM))->name}}" readonly></td>
