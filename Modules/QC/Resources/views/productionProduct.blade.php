            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Product Inspection Note</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{url('qc/product-inspection')}}" method="post" enctype="multipart/form-data">
                                                                    @csrf
                                            ...
                                            @else
                                                ...
                                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModal21{{$item->id}}">
                                                    View I-Note
                                                </button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModal21{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Inspection Note Product</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form action="{{url('qc/product-inspection')}}" method="post" enctype="multipart/form-data">
