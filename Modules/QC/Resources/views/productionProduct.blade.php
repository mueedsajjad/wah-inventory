                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->inspectionStatus==NULL)
                                                <a href="{{url('store/add_i_note_product/'.$item->id)}}" class="btn btn-secondary btn-sm">Add I-Note</a>
                                            @else
                                                <a href="{{url('store/add_i_note_product/'.$item->id)}}" class="btn btn-success btn-sm">View I-Note</a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($item->inspectionStatus==NULL)
