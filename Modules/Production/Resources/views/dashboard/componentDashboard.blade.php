                                                                                    ...
                                                                                    <table id="pageTable" class="table table-bordered" >
                                                                                        ...
                                                                                        @foreach($orders as $order)
                                                                                            @if($order->status==0 || $order->status==1||$order->status==2)
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>{{$n}}</td>
                                                                                                    <td><a href="#">{{$order->manufacturing_order}}</a></td>
                                                                                                    ...
                                                                                                    <form action="{{url('production/processStatusComponent')}}" method="post">
                                                                                                        @csrf
                                                                                                        <td class="bg-light text-center">
                                                                                                            <div class="form-group m-0">
                                                                                        ...
                                                                                        @foreach($orders as $order)
                                                                                            ...
                                                                                            @if($order->status==3 || $order->status==4 || $order->status==5)
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <form action="{{url('production/transferComponent')}}" method="post">
                                                                                                        @csrf
                                                                                                        @if(auth()->user()->can('Product Transfer'))
                                                            ...
                                                            @foreach($orders as $order)
                                                                @if($order->status==1 || $order->status==2 || $order->status==3)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$order->production_deadline}}</td>
                                                                        <td>{{$order->component_name}}</td>
                                                                        <td>{{$order->component_name}} Making</td>
