                                    ...
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div class="tab-pane text-left fade active show" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                                            ...
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                <tr>
                                                    <td>{{$unit->name}}</td>
                                                    <td><a class="text-danger" href="{{url('production/unitDelete/'.$unit->id)}}"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
...
{{--                                            <p>The categories here can be assigned to items for better organizing and grouping of products and materials.</p>--}}
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                <tr>
                                                    <td>{{$category->name}}</td>
                                                    <td><a class="text-danger" href="{{url('production/categoryDelete/'.$category->id)}}"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
...
{{--                                            <p>You can reorder Operations in this list. The same order is used in the selection menu when choosing a Production Operation for a product.</p>--}}
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="text-danger" href="{{url('production/operationDelete/'.$operation->id)}}"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                        ...
                                        <div class="tab-pane fade" id="vert-tabs-settings" role="tabpanel" aria-labelledby="vert-tabs-settings-tab">
                                            ...
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                <tr>
                                                    <td>{{$store->name}}</td>
                                                    <td><a class="text-danger" href="{{url('production/storeDelete/'.$store->id)}}"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                               @endforeach
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                @foreach($departments as $department)
                                                    <tr>
                                                        ...
                                                        <td><a class="text-danger" href="{{url('production/departmentDelete/'.$department->id)}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
...
{{--  unit modal --}}
    <div class="modal fade" id="modal-unit">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{url('production/unitStore')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="modal-category">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{url('production/categoryStore')}}" METHOD="post">
                    @csrf
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal-operation">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{url('production/operationStore')}}" method="post">
                    @csrf
                <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal-store">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('production/storeStore')}}">
                    @csrf
                <div class="modal-body">
    ...
    <div class="modal fade" id="modal-departments">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('production/departmentStore')}}">
                    @csrf
                    <div class="modal-body">
