            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Approve Inward Component in Respective Store</h3>
                            ...
                            @if(!$inward_raw_material->isempty())
                                @foreach($inward_raw_material as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status==5)
                                                <form action="{{url('store/submitFactoryInwardComponentToStore')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
