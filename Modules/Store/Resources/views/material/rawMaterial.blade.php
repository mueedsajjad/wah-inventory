                        ...
                        <div class="table-responsive">
                            <table id="materialTable" class="table table-bordered table-striped">
                                ...
                                @if(!$material->isempty())
                                    ...
                                    @endforeach
                                @else
                                    <tr aria-colspan="10" class="align-content-center">No Data.</tr>
                                @endif
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="sga_14" class="col-sm-4 col-form-label">Material Name</label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="sga_15" class="col-sm-4 col-form-label">Material Description</label>
                            <div class="col-sm-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="sga_15" class="col-sm-4 col-form-label">Material Description</label>
                                <div class="col-sm-8">
                                    <input type="text" readonly required name="description" class="form-control editdescription" id="" placeholder="Product Description Here...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="sga_16" class="col-sm-4 col-form-label">Quantity</label>
                                <div class="col-sm-8">
                                    <input type="text" required readonly name="qty" class="form-control editqty" id="" placeholder="250">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="sga_16" class="col-sm-4 col-form-label">Rate</label>
                                <div class="col-sm-8">
                                    <input type="text" required readonly name="rate" class="form-control editrate" id="" placeholder="175">
                                </div>
                            </div>
                        </div>
                    </div>
