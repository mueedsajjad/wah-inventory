                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success btn-sm ml-1 editAttendance" type="button" data-toggle="modal" data-target="#modal-edit"
                                           data-id="{{$attendances->attendance_id}}" data-name="{{$attendances->name}}"
                                           data-userid="{{$attendances->userId}}"  data-status="{{$attendances->status}}"
                                           data-intime="{{$attendances->inTime}}"  data-outtime="{{$attendances->outTime}}"
                                           data-date="{{$attendances->date}}" data-late="{{$attendances->late}}">
                                            <i class="fa fa-edit pr-1"></i>
                                            Edit
                                        </a>

                                        <a href="#" class="btn btn-danger btn-sm ml-1 deleteMaterial" data-id="{{$attendances->attendance_id}}" type="button"  data-toggle="modal" data-target="#modal-delete"><i class="fa fa-trash pr-1" class="text-red"></i>Delete</a>
                                    </td>
                                </tr>
                             @endforeach
                                </tbody>
