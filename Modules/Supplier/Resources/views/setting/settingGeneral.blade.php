                                        ...
                                        <div class="tab-pane text-left fade active show" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                                            ...
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                @foreach($credit as $credits)
                                                    <tr>
                                                        <td>{{$credits->name}}</td>
                                                        <td><a class="text-danger" href="{{url('supplier/creditDelete/'. $credits->id)}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
...
{{--                                                                                        <p>The categories here can be assigned to items for better organizing and grouping of products and materials.</p>--}}
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                @foreach($state as $states)
                                                    <tr>
                                                        <td>{{$states->name}}</td>
                                                        <td><a class="text-danger" href="{{url('supplier/stateDelete/'.$states->id)}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
...
{{--                                                                                        <p>You can reorder Operations in this list. The same order is used in the selection menu when choosing a Production Operation for a product.</p>--}}
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                @foreach($city as $cities)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="text-danger" href="{{url('supplier/cityDelete/'.$cities->id)}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                        ...
                                        <div class="tab-pane fade" id="vert-tabs-settings" role="tabpanel" aria-labelledby="vert-tabs-settings-tab">
                                            ...
                                            <table class="table table-bordered col-md-3">
                                                ...
                                                @foreach($payment as $payments)
                                                    <tr>
                                                        <td>{{$payments->name}}</td>
                                                        <td><a class="text-danger" href="{{url('supplier/paymentDelete/'.$payments->id)}}"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
    ...
    <div class="modal fade" id="modal-credit">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{url('supplier/creditStore')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="modal-state">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{url('supplier/stateStore')}}" METHOD="post">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal fade" id="modal-city">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{url('supplier/cityStore')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal-payment">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('supplier/paymentStore')}}">
                    @csrf
                    <div class="modal-body">
